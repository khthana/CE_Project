...
+        t4.Subj_Id,t4.Subj_Name_Eng,t4.Credit_Lec,t4.Credit_Lab,
+        t5.Teacher_Id,t5.Subj_Id,t5.Academic_Year,t5.Academic_Term,
+        t6.Teacher_Id,Teacher_Name_Thai,Teacher_Sname_Thai      
+from    Room t1,Building t2, Class t3,Subject t4,TeacherClass t5,TeacherInfo t6 
+where   t1.Building = t2.Building_Code and t3.room_code = t1.room_code 
+        and t3.Subj_Id = t4.Subj_Id
+        and t5.Subj_Id = t4.Subj_Id and t5.Teacher_Id = t6.Teacher_Id 
+        and t4.Subj_Name_Eng like '%Subj_Name_Eng%%'
Username: webusr