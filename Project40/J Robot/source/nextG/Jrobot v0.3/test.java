...
public class test extends java.applet.Applet implements Runnable {
  ...
  public void init() {
    ...
    sDigit = new Image[10];
    for (int i = 0; i < 10; i++) {
      lDigit[i] = getImage(getCodeBase(),"images/digit" + i + ".gif");
      tracker.addImage(lDigit[i],0);
      sDigit[i] = getImage(getCodeBase(),"images/sd" + i + ".gif");
      tracker.addImage(sDigit[i],0);
    }
  ...
  public void displayTime(Graphics gt) {
    ...
    gt.drawImage(colon,38,400,this);    
    gt.drawImage(lDigit[min],20,400,this);
    gt.drawImage(lDigit[fsec],56,400,this);
    gt.drawImage(lDigit[ssec],80,400,this);
    gt.drawImage(sDigit[tsec],108,412,this);
  }
