...
procedure TComform.QuitBtnClick(Sender: TObject);
begin
  Close;
end;

procedure TComform.TxMemoKeyPress(Sender: TObject; var Key: Char);
var s: string;
begin
...
procedure TComform.CommPortDriverReceiveData(Sender: TObject;
...
procedure TComform.ConnectBtnClick(Sender: TObject);
begin
  // Apply settings
  ApplyCommSettings;
  // Connect
...
procedure TComform.DisconnectBtnClick(Sender: TObject);
begin
...
procedure TComform.BaudRateRGClick(Sender: TObject);
begin
  CommPortDriver.ComPortSpeed := TComPortBaudRate(BaudRateRG.ItemIndex+1);
end;

procedure TComform.DataBitsRGClick(Sender: TObject);
begin
  CommPortDriver.ComPortDataBits := TComPortDataBits(DataBitsRG.ItemIndex);
end;

procedure TComform.ParityRGClick(Sender: TObject);
begin
  CommPortDriver.ComPortParity := TComPortParity(ParityRG.ItemIndex);
end;

procedure TComform.HandshakingRGClick(Sender: TObject);
begin
...
procedure TComform.ComPortRGClick(Sender: TObject);
begin
  // Apply com settings
  //ApplyCommSettings;
end;

procedure TComform.ApplyCommSettings;
...
procedure TComform.ClrInMemoClick(Sender: TObject);
begin
  RxMemo.Lines.Clear;
end;

procedure TComform.ClrOutMemoClick(Sender: TObject);
begin
  TxMemo.Lines.Clear;
end;

procedure TComform.SetDTRBtnClick(Sender: TObject);
begin
  CommPortDriver.ToggleDTR( true );
end;

procedure TComform.ClrDTRBtnClick(Sender: TObject);
begin
  CommPortDriver.ToggleDTR( false );
end;

procedure TComform.SetRTSBtnClick(Sender: TObject);
begin
  CommPortDriver.ToggleRTS( true );
end;

procedure TComform.ClrRTSBtnClick(Sender: TObject);
begin
