...
public class serview extends HttpServlet{
...
//////////////////////////////////////
 ...
 if (!timeup.equals("#")){
	...
	String in1  = cutString(queryHost(ip,"1.3.6.1.2.1.2.2.1.10.3"));
	String out1 = cutString(queryHost(ip,"1.3.6.1.2.1.2.2.1.16.3"));
	String in2  = cutString(queryHost(ip,"1.3.6.1.2.1.2.2.1.10.4"));
	String out2 = cutString(queryHost(ip,"1.3.6.1.2.1.2.2.1.16.4"));	

	String in3  = cutString(queryHost(ip,"1.3.6.1.2.1.10.7.2.1.4.3"));
	String out3 = cutString(queryHost(ip,"1.3.6.1.2.1.10.7.2.1.4.4"));
	String in4  = cutString(queryHost(ip,"1.3.6.1.2.1.10.7.2.1.5.3"));
	String out4 = cutString(queryHost(ip,"1.3.6.1.2.1.10.7.2.1.5.4"));	
	String in5  = cutString(queryHost(ip,"1.3.6.1.2.1.10.7.2.1.7.3"));
	String out5 = cutString(queryHost(ip,"1.3.6.1.2.1.10.7.2.1.7.4"));

	out.println("&nbsp&nbsp&nbsp&nbsp<font color=blue>Octet Now!</font><br><br>"); 
    out.println("<table width=85% cellspacing=0 cellpadding=5 border=1>");

	out.println("<tr align=center>");
    out.println("<th>Description</th>");
    out.println("<th>Inoctet</th>");
    out.println("<th>Outoctet</th>");
    out.println("<th>SingleColli</th>");
    out.println("<th>MultipleColli</th>");
    out.println("<th>DeferTran</th>");
    out.println("</tr>");
    ...
    out.println("<td align=center>"+out3+"</td>");
    out.println("<td align=center>"+out4+"</td>");
    out.println("<td align=center>"+out5+"</td>");
    out.println("</tr>");
