...
Begin VB.Form HeaderSub3 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"HeaderSub3.frx":0000
      Caption         =   " "
   ...
   Begin VB.Label lblLabels 
      BackColor       =   &H0000FF00&
      Caption         =   "รายละเอียดหัวเรื่องย่อย3:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   222
   ...
   Begin VB.Label lblLabels 
      BackColor       =   &H0000FF00&
      Caption         =   "คำแปลภาษาอังกฤษหัวเรื่องย่อย3:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   222
...
HeaderSub2.Refresh
txtFields(0).Text = HeaderSub2.txtFields(0).Text
txtFields(1).Text = HeaderSub2.txtFields(1).Text
txtFields(2).Text = HeaderSub2.txtFields(2).Text
retcount = 0
addflag = True
End Sub
...
If txtFields(0) <> "" And txtFields(1) <> "" And txtFields(2) <> "" And txtFields(3) <> "" Then
  ...
  MsgBox ("Updateข้อมูลแล้ว")
        ...
        End If
    Else
        MsgBox ("คุณต้องกรอกหัวเรื่อง,หัวเรื่องย่อย1,หัวเรื่องย่อย2และหัวเรื่องย่อย3ก่อน")
        txtFields(0).SetFocus
         retcount = 0
End If
    Exit Sub
...
If KeyAscii = vbKeyReturn Then
    ...
    End If
    If retcount = 18 Then
    If retcount = 18 And txtFields(0) <> "" And txtFields(1) <> "" And txtFields(2) <> "" And txtFields(3) <> "" And addflag = True Then
            datPrimaryRS.Recordset.UpdateBatch adAffectAll
            Call cmdAdd_Click
        End If
    End If
