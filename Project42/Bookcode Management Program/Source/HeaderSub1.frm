...
Begin VB.Form HeaderSub1 
   ...
   ScaleHeight     =   8130
   ScaleWidth      =   8415
   Begin VB.ComboBox ChooseSub1 
      Height          =   315
      ItemData        =   "HeaderSub1.frx":0000
      Left            =   4800
      List            =   "HeaderSub1.frx":000A
      TabIndex        =   38
      Text            =   "กรุณาเลือก"
      Top             =   6240
      Width           =   1695
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"HeaderSub1.frx":0033
      Caption         =   " "
   ...
   Begin VB.Label lblLabels 
      BackColor       =   &H0000FF00&
      Caption         =   "รายละเอียดหัวเรื่องย่อย1:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   222
   ...
   Begin VB.Label lblLabels 
      BackColor       =   &H0000FF00&
      Caption         =   "คำแปลภาษาอังกฤษหัวเรื่องย่อย1:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   222
...
End Enum
Dim OSId As OSType
Private Sub ChooseSub1_KeyPress(KeyAscii As Integer)
 If KeyAscii = vbKeyReturn Then
 If Back2 = False Then
If retcount = 16 And txtFields(0) <> "" And txtFields(1) <> "" And addflag = True Then
        If ChooseSub1.ListIndex = 1 Then
             txtFields(14).Text = "ไม่มีหัวข้อย่อย"
            datPrimaryRS.Recordset.UpdateBatch adAffectAll
            Call cmdAdd_Click
        End If
        If ChooseSub1.ListIndex = 0 Then
            txtFields(14).Text = "มีหัวข้อย่อย"
            datPrimaryRS.Recordset.UpdateBatch adAffectAll
            HeaderSub1.Hide
            HeaderSub2.Show
        End If
...
HeaderMain.Refresh
txtFields(0).Text = HeaderMain.txtFields(0).Text
retcount = 0
addflag = True
End Sub
...
If txtFields(0) <> "" And txtFields(1) <> "" Then
  ...
  MsgBox ("Updateข้อมูลแล้ว")
        ...
        End If
    Else
        MsgBox ("คุณต้องกรอกหัวเรื่องและหัวเรื่องย่อย1ก่อน")
        txtFields(0).SetFocus
         retcount = 0
End If
    Exit Sub
