...
begin
          ...
          else MessageDlg('You don''t have any order',mtWarning,[mbOK],0);
end;
...
begin
     Form4.Show;
     Form4.Edit21.Text := DBEdit1.Text;
     Form4.EDit22.Text := Edit4.Text;
     Form4.Edit23.Text := DBEdit5.Text;
     Form4.Edit24.Text := DBEdit6.Text;
     Form4.Edit25.Text := DBEdit7.Text;
     ControlBar2.Visible := True;
