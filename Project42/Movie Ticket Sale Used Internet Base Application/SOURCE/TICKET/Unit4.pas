...
procedure TForm4.Button105Click(Sender: TObject);
begin
...
procedure TForm4.Button104Click(Sender: TObject);
begin
...
procedure TForm4.Button102Click(Sender: TObject);
begin
     For i := 1 to 20 do
     begin
          SeatTemp[i] := '';
...
procedure TForm4.Button103Click(Sender: TObject);
begin

     {* Select order *}
     SelectCount := 0;
     memo1.lines.clear;
     memo1.lines.add('You selected the ticket number: ');
     For i := 1 to 20 do
     ...
     begin
          If MessageDlg('Confirm this selection',mtConfirmation,[mbYES,mbNo],0)= mrYes then
          begin
               j := 0;
               with query1 do
               begin
