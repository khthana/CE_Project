...
Begin VB.Form Menu 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Index           =   1
         Left            =   2700
         MouseIcon       =   "Menu.frx":1ED9
         MousePointer    =   99  'Custom
         Picture         =   "Menu.frx":27A3
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "เพลง"
         Top             =   2160
      ...
      Begin VB.CommandButton Command1 
         ...
         Index           =   0
         Left            =   840
         MouseIcon       =   "Menu.frx":289B
         MousePointer    =   99  'Custom
         Picture         =   "Menu.frx":3165
         Style           =   1  'Graphical
         TabIndex        =   0
         ToolTipText     =   "หนังสือ"
         Top             =   2160
...
Private Sub Command3_Click()
    MsgBox ("Copy Right by 39014043 and 39014309")
End Sub
