...
{ALG_ID crackers }
function GET_ALG_CLASS(x:integer) :integer; {Function from C Macro.}
function GET_ALG_TYPE(x:integer) :integer;  {Function from C Macro.}
function GET_ALG_SID(x:integer) :integer;   {Function from C Macro.}
...
function RCRYPT_SUCCEEDED(rt:BOOL):BOOL; {Function from C Macro.}
function RCRYPT_FAILED(rt:BOOL):BOOL;    {Function from C Macro.}
