...
echo "<P align=right><FONT SIZE='+2'><B><FONT SIZE='+1'>".
	"$date$t"." ".$mount." ".$year." "." 
	$hour".":"."$minute".":"."$second"."
"."$ampm"." "."</FONT></B></FONT></P>";
...
ECHO "
	 <P><FONT SIZE='+2' COLOR='#339900'><U><B><FONT
		SIZE='+2'>การสมัครสมาชิก</FONT></B></U> <FONT
COLOR='#FF0000'>(* = ต้องการ)</FONT></FONT></P> 
	 <P></P> 
	 <FORM action
='http://161.246.5.146/auction1/regis/preview_page.php3' 
	       method=post>  		
...
BORDER='0' align=center> 
							 <TR> 
								<TD VALIGN='MIDDLE'>
								  <INPUT
TYPE='RADIO' NAME='title' VALUE='นาย' CHECKED='CHECKED'>นาย</TD>  
							<TD> <INPUT
TYPE='RADIO' NAME='title' 					
		  VALUE='นางสาว'>นางสาว</TD>  			
...
BORDER='0'>  							 <TR> 
								<TD
HEIGHT='40' WIDTH='105' align=right>ชื่อเล่น :</TD>  			
				<TD HEIGHT='40' WIDTH='319'>&nbsp;<INPUT
TYPE='TEXT' 								 
NAME='nickname' maxlength=25> <FONT COLOR='#FF0000'>* (ไม่เกิน 25
ตัวอักษร)</FONT><FONT 		
					  COLOR='#FF0000'></FONT></TD> 
							 </TR>  
						 <TR>  	
						<TD HEIGHT='40'
WIDTH='105' align=right>ชื่อ :</TD>  					
		<TD HEIGHT='40' WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 
							  NAME='firstname'
SIZE='30' maxlength=50> <FONT COLOR='#FF0000'>*</FONT></TD>  		
				 </TR>  			
			 <TR>  				
			<TD HEIGHT='40' WIDTH='105' align=right>นามสกุล
:</TD>  
							<TD HEIGHT='40'
WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 				
			  NAME='lastname' SIZE='30' maxlength=50> <FONT
COLOR='#FF0000'>*</FONT></TD>  				
		 </TR>  					
	 <TR>  						
	<TD HEIGHT='40' WIDTH='105' align=right>วันเกิด :</TD>  		
					<TD HEIGHT='40'
WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 				
			  NAME='birth' maxlength=20></TD>  			
			 </TR>  				
	  </TABLE> </TD>  					 </TR> 
				  </TABLE> <BR>  		
	  <TABLE WIDTH='100%' BORDER='0' BGCOLOR='#66CCCC'>  	
			 <TR>  				
	<TD WIDTH='100%'>  						 
<TABLE WIDTH='100%' BORDER='0'>  				
		 <TR>  					
		<TD HEIGHT='40' WIDTH='105'
align=right>ที่อยู่อีเมล์
:</TD>  
							<TD HEIGHT='40'
WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 				
			  NAME='email' SIZE='30' maxlength=50> <FONT
COLOR='#FF0000'>*</FONT></TD>  				
		 </TR>  					
	 <TR>  						
	<TD HEIGHT='40' WIDTH='105' align=right>ที่อยู่ :</TD>  		
					<TD HEIGHT='40'
WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 				
			  NAME='address' SIZE='30' maxlength=80> <FONT
COLOR='#FF0000'>* <br>บ้านเลขที่ หมู่ที่ ตำบน/เขต </FONT></TD>  				
		 </TR>  					
	 <TR>  						
	<TD HEIGHT='40' WIDTH='105' align=right>อำเภอ /เขต:</TD>  		
					<TD HEIGHT='40'
WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 				
			  NAME='bound'  maxlength=50> <FONT
COLOR='#FF0000'>*</FONT></TD> 
							 </TR>  
						 <TR>  	
						<TD HEIGHT='40'
WIDTH='105' align=right>จังหวัด :</TD>  					
...
<option value=1>เชียงใหม่</option>
	 ...
	 <TR>  						
	<TD HEIGHT='40' WIDTH='105' align=right>รหัสไปรษณีย์ :</TD>  	
						<TD HEIGHT='40'
WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 				
			  NAME='postal'  maxlength=5> <FONT
COLOR='#FF0000'>*</FONT></TD> 
							 </TR>  
					  </TABLE></TD>  	
			 </TR>  				  </TABLE>
...
BGCOLOR='#66CCFF'>  					 <TR>  
				  ...
				  <TABLE WIDTH='97%' BORDER='0'>  
						 <TR>  	
						<TD HEIGHT='40'
WIDTH='105' align=right>โทรศัพท์ :</TD>  				
			<TD HEIGHT='40' WIDTH='319'>&nbsp;<INPUT TYPE='TEXT'
								 
NAME='phone' maxlength=10> <FONT COLOR='#FF0000'> </FONT>เช่น
074-123456</TD>  
						 </TR>  	
					 <TR>  		
					<TD HEIGHT='40' WIDTH='105'
align=right>แฟกซ์ :</TD>
 								<TD
HEIGHT='40' WIDTH='319'>&nbsp;<INPUT TYPE='TEXT' 		
					  NAME='fax' maxlength=10></TD>  	
					 </TR>  		
				 <TR>  			
				<TD HEIGHT='40' WIDTH='105'
align=right>เพจ :</TD>
...
BGCOLOR='#66cccc'> 
		  ...
		  <TABLE WIDTH='100%' BORDER='0'>  		
				 <TR>  			
				<TD HEIGHT='40' WIDTH='105'
align=right>รหัสผ่าน :</TD> 
								<TD
HEIGHT='40' WIDTH='319'>&nbsp;<INPUT TYPE='PASSWORD' 		
					  NAME='password' MAXLENGTH='25'>
 <FONT COLOR='#FF0033'>* (ไม่เกิน 25 ตัวักษร)</FONT></TD>  				
		 </TR>  					
	 <TR>  						
	<TD HEIGHT='40' WIDTH='105' align=right>รหัสผ่าน (ซ้ำ) :</TD>  	
						<TD HEIGHT='40'
...
<P><INPUT TYPE='SUBMIT' NAME='Preview' VALUE='แสดงตัวอย่าง'> 	
