 ...
 */
public class EMPMenu implements java.awt.event.ActionListener, java.awt.event.WindowListener {
	public int IDProject=0;
	public int IDEmployee=0;
	public JFrame FLogin=null;
	...
	private JButton ivjBCustomer = null;
	private JButton ivjBSummary = null;
	private JFrame ivjFEMPMenu = null;
/**
 * Constructor
 */
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public EMPMenu(JFrame jf,int idP,int idE) {
	super();
	FLogin = jf;
	IDProject = idP;
	IDEmployee = idE;
...
public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	if ((e.getSource() == getBCustomer()) ) {
		customerGUI = new CustomerGUI(getFEMPMenu(),IDEmployee);
	}
	if ((e.getSource() == getBSummary()) ) {
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private JButton getBCustomer() {
	if (ivjBCustomer == null) {
		try {
			ivjBCustomer = new com.sun.java.swing.JButton();
			ivjBCustomer.setName("BCustomer");
			ivjBCustomer.setText("Customer Editor");
			ivjBCustomer.setBackground(java.awt.SystemColor.text);
			ivjBCustomer.setBounds(150, 25, 150, 25);
			ivjBCustomer.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private JButton getBProject() {
	if (ivjBProject == null) {
		try {
			...
			ivjBProject.setText("Project Service");
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private JButton getBSummary() {
	if (ivjBSummary == null) {
		try {
			ivjBSummary = new com.sun.java.swing.JButton();
			ivjBSummary.setName("BSummary");
			ivjBSummary.setText("Project Summary");
			ivjBSummary.setBackground(java.awt.SystemColor.text);
			ivjBSummary.setBounds(150, 95, 150, 25);
			ivjBSummary.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private JFrame getFEMPMenu() {
	if (ivjFEMPMenu == null) {
		try {
			ivjFEMPMenu = new com.sun.java.swing.JFrame();
			ivjFEMPMenu.setName("FEMPMenu");
			ivjFEMPMenu.setDefaultCloseOperation(com.sun.java.swing.WindowConstants.DISPOSE_ON_CLOSE);
			ivjFEMPMenu.setBounds(405, 100, 320, 183);
			ivjFEMPMenu.setTitle("Employee Menu");
			getFEMPMenu().setContentPane(getJFrameContentPane());
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private void initConnections() {
	...
	getBSummary().addActionListener(this);
	getBProject().addActionListener(this);
	// user code end
	getBLogout().addActionListener(this);
	getFEMPMenu().addWindowListener(this);
}
/**
...
private void initialize() {
	// user code begin {1}
	getFEMPMenu().show();
	getFEMPMenu().setVisible(true);
	getFEMPMenu().setEnabled(true);
	// user code end
	initConnections();
	// user code begin {2}
	// user code end
