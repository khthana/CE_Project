 ...
 */
public class Customer_Service implements java.awt.event.ActionListener, java.awt.event.MouseListener, java.awt.event.WindowListener {
...
private com.sun.java.swing.JButton getBAddNewProject() {
	if (ivjBAddNewProject == null) {
		try {
			...
			ivjBAddNewProject.setVisible(false);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JButton getBUpdateProject() {
	if (ivjBUpdateProject == null) {
		try {
			...
			ivjBUpdateProject.setFont(new java.awt.Font("dialog", 1, 12));
			ivjBUpdateProject.setText("Update Project");
			ivjBUpdateProject.setBounds(410, 14, 125, 33);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JFrame getFProject_Editor() {
	if (ivjFProject_Editor == null) {
		try {
			...
			ivjFProject_Editor.setTitle("Customer Service");
...
private com.sun.java.swing.JLabel getLMainMap() {
	if (ivjLMainMap == null) {
		try {
			...
			ivjLMainMap.setIcon(new com.sun.java.swing.ImageIcon("..\\test\\PictureAndIcon\\detail.jpg"));
...
public static void main(java.lang.String[] args) {
	try {
		Customer_Service aProject_Editor;
		aProject_Editor = new Customer_Service();
