 ...
 */
public class Service implements java.awt.event.ActionListener, java.awt.event.MouseListener, java.awt.event.WindowListener {
	...
	for(int x=startX;x<=endX;x++) {
	 for(int y=startY;y<=endY;y++) {
		 ...
		 switch (iMapArray[x][y]) {
			...
			case 5:{getLMapArray(x,y).setIcon(new com.sun.java.swing.ImageIcon("..\\test\\PictureAndIcon\\single.jpg"));} break; 
...
public static void main(java.lang.String[] args) {
	try {
		Service aProject_Editor;
		aProject_Editor = new Service();
