 ...
 */
public class Project_Editor implements java.awt.event.ActionListener, java.awt.event.MouseListener, java.awt.event.WindowListener {
...
/**
 * connEtoC5:  (FProject_Editor.window.windowClosed(java.awt.event.WindowEvent) --> Project_Editor.fProject_Editor_WindowClosed(Ljava.awt.event.WindowEvent;)V)
 * @param arg1 java.awt.event.WindowEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private void connEtoC5(java.awt.event.WindowEvent arg1) {
	try {
		// user code begin {1}
		// user code end
		this.fProject_Editor_WindowClosed(arg1);
		// user code begin {2}
		// user code end
	} catch (java.lang.Throwable ivjExc) {
		// user code begin {3}
...
/**
 * connEtoM5:  (MIExit.action.actionPerformed(java.awt.event.ActionEvent) --> FProject_Editor.dispose()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
 ...
 * Comment
 */
public void fProject_Editor_WindowClosed(java.awt.event.WindowEvent windowEvent) {
	return;
}
/**
...
private com.sun.java.swing.JButton getBAddNewProject() {
	if (ivjBAddNewProject == null) {
		try {
			...
			ivjBAddNewProject.setBounds(660, 12, 125, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JButton getBCancel() {
	if (ivjBCancel == null) {
		try {
			...
			ivjBCancel.setBounds(120, 90, 85, 25);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JButton getBUpdateProject() {
	if (ivjBUpdateProject == null) {
		try {
			...
			ivjBUpdateProject.setBounds(660, 32, 125, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JDialog getDSetMap() {
	if (ivjDSetMap == null) {
		try {
			...
			ivjDSetMap.setBounds(310, 280, 224, 154);
			ivjDSetMap.setVisible(true);
...
private com.sun.java.swing.JPanel getFDrawMap() {
	if (ivjFDrawMap == null) {
		try {
			...
			ivjFDrawMap.setBackground(new java.awt.Color(230,230,230));
			ivjFDrawMap.setVisible(true);
			...
			// user code begin {1}
			//ivjFDrawMap.setBackground(java.awt.SystemColor.text);
...
private com.sun.java.swing.JPanel getJDialogContentPane1() {
	if (ivjJDialogContentPane1 == null) {
		try {
			...
			ivjJDialogContentPane1.setBackground(new java.awt.Color(230,230,230));
...
private com.sun.java.swing.JLabel getJLabel1() {
	if (ivjJLabel1 == null) {
		try {
			...
			ivjJLabel1.setIcon(new com.sun.java.swing.ImageIcon("..\\test\\PictureAndIcon\\table.jpg"));
			ivjJLabel1.setText("");
			ivjJLabel1.setBounds(19, 9, 70, 73);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JLabel getJLabel3() {
	if (ivjJLabel3 == null) {
		try {
			...
			ivjJLabel3.setIcon(new com.sun.java.swing.ImageIcon("..\\test\\PictureAndIcon\\labelProject.jpg"));
			ivjJLabel3.setFont(new java.awt.Font("dialog", 1, 36));
			ivjJLabel3.setBounds(46, 2, 261, 65);
...
private com.sun.java.swing.JLabel getJLabel4() {
	if (ivjJLabel4 == null) {
		try {
			...
			ivjJLabel4.setBounds(100, 15, 35, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JLabel getJLabel5() {
	if (ivjJLabel5 == null) {
		try {
			...
			ivjJLabel5.setBounds(100, 40, 26, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JLabel getJLabel6() {
	if (ivjJLabel6 == null) {
		try {
			...
			ivjJLabel6.setBounds(310, 12, 66, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JLabel getJLabel8() {
	if (ivjJLabel8 == null) {
		try {
			...
			ivjJLabel8.setBounds(425, 12, 38, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JPanel getJPanel2() {
	if (ivjJPanel2 == null) {
		try {
			...
			ivjJPanel2.setBackground(java.awt.SystemColor.text);
...
private com.sun.java.swing.JLabel getLSize() {
	if (ivjLSize == null) {
		try {
			...
			ivjLSize.setBounds(310, 32, 101, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JLabel getLTotalHome() {
	if (ivjLTotalHome == null) {
		try {
			...
			ivjLTotalHome.setBounds(425, 32, 116, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JLabel getLTotalMap() {
	if (ivjLTotalMap == null) {
		try {
			...
			ivjLTotalMap.setBounds(550, 32, 106, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JTextField getTFProjectID() {
	if (ivjTFProjectID == null) {
		try {
			...
			ivjTFProjectID.setBackground(new java.awt.Color(255,255,235));
			ivjTFProjectID.setBounds(380, 12, 30, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JTextField getTFProjectName() {
	if (ivjTFProjectName == null) {
		try {
			...
			ivjTFProjectName.setBackground(new java.awt.Color(255,255,235));
			ivjTFProjectName.setBounds(470, 12, 179, 15);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JTextField getTFStatusID() {
	if (ivjTFStatusID == null) {
		try {
			...
			ivjTFStatusID.setBackground(new java.awt.Color(255,255,235));
...
private com.sun.java.swing.JTextField getTFTypeID() {
	if (ivjTFTypeID == null) {
		try {
			...
			ivjTFTypeID.setBackground(new java.awt.Color(255,255,235));
...
private com.sun.java.swing.JTextField getTFX() {
	if (ivjTFX == null) {
		try {
			...
			ivjTFX.setName("TFX");
			ivjTFX.setBackground(new java.awt.Color(255,255,235));
			ivjTFX.setBounds(130, 15, 70, 19);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private com.sun.java.swing.JTextField getTFY() {
	if (ivjTFY == null) {
		try {
			...
			ivjTFY.setName("TFY");
			ivjTFY.setBackground(new java.awt.Color(255,255,235));
			ivjTFY.setBounds(130, 40, 70, 19);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private void initConnections() {
	...
	getMIExit().addActionListener(this);
	getFProject_Editor().addWindowListener(this);
}
/**
...
public void windowClosed(java.awt.event.WindowEvent e) {
	...
	if ((e.getSource() == getFProject_Editor()) ) {
		connEtoC5(e);
	}
	// user code begin {2}
	// user code end
