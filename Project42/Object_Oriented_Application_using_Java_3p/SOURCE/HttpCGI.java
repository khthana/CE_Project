...
public class HttpCGI implements HttpProcessor, Runnable {
    ...
    public HttpCGI (HttpInputStream in, InetAddress ip) throws IOException {
        ...
        throw new HttpException (HTTP.STATUS_NOT_IMPLEMENTED,"Parse-header CGI unimplemented");
    ...
    //---------------------------------------
            ...
            protected void initEnv (InetAddress ip) {
                ...
                environment.addElement("PATH_TRANSLATED = "+ new File (
                HTTP.HTML_ROOT, HTTP.translateFilename (pathInfo) ) );
            }
    ...
    public void run() {
        ...
        try {
            ...
            int len;
            while (!Thread.interrupted() && (contentLength > 0) &&
