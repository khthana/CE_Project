VERSION 5.00
Begin VB.Form QForm2 
   Caption         =   "ประวัติของนักศึกษา ...."
   ClientHeight    =   2835
   ClientLeft      =   3075
   ClientTop       =   4320
   ClientWidth     =   4335
...
SelectSql = "select * from student_tt where std_int in (select distinct(std_int) from student_tt where "
SelectSql = SelectSql + FieldStd + " = """ + RowStudent.Text + """ )"
