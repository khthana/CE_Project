...
/////////////////////////////////////////////////////////////////////////////
HRESULT DX_Surface::Create (LPDIRECTDRAW pDD)
{
	HRESULT rval;
	...
	// Create the surface
	if (FAILED (rval = pDD->CreateSurface (&m_Desc, &m_Surface, NULL)))
		return rval;
...
/////////////////////////////////////////////////////////////////////////////
HRESULT DX_Surface::Create (LPDIRECTDRAW pDD, int width, int height)
{
	Finalise ();
	Initialise ();
	...
	// Create the surface
	return pDD->CreateSurface (&m_Desc, &m_Surface, NULL);
}
...
/////////////////////////////////////////////////////////////////////////////
HRESULT DX_Surface::LoadBitmap (LPDIRECTDRAW pDD, const char* filename)
{
	HRESULT rval;
	HBITMAP hbm;
	BITMAP bm;
...
// Desc: Use Blit
/////////////////////////////////////////////////////////////////////////////
HRESULT DX_Surface::Draw (LPDIRECTDRAWSURFACE Dest, DWORD Flags)
{
	HRESULT rval;

	if (Dest != NULL)
		rval = Dest->Blt (&m_DestRect, m_Surface, &m_SrcRect, Flags, NULL);
...
// Desc: Use BltFast
/////////////////////////////////////////////////////////////////////////////
HRESULT DX_Surface::DrawFast (int X, int Y, LPDIRECTDRAWSURFACE Dest, DWORD Flags)
{
	HRESULT rval;

	if (Dest != NULL)
		rval = Dest->BltFast (X, Y, m_Surface, &m_SrcRect, Flags);
	if (rval == DDERR_SURFACELOST)
		Restore ();
